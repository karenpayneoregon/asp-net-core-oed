...
namespace HelperFormsApp
{
    public class PathHelpers
    {
        ...
        /// <summary>
        /// Get Windows short path for a folder. If the folder name length is
        /// greater than <see cref="MAX_PATH"/> then the original path is returned
        /// as <see cref="GetShortPathName"/> does not work well in these cases.
        /// </summary>
